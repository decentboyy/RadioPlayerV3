...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @Octave_support 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
© **Powered By** : 
**@Octave_support | @pglpnti_ki_duniya** 👑
"""
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/Octave_support"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/pglpnti_ki_duniya"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/Octave_support/14"),
                InlineKeyboardButton("SOURCE CODE", url="https://graph.org/file/afea72d2fc5233e686b75.mp4"),
            ],
            [
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://graph.org/file/3d2eec6223e6b1e23c085.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://graph.org/file/3d2eec6223e6b1e23c085.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
